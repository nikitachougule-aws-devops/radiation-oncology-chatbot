...
st.markdown("""
    <style>
        ...
        .hero {
            ...
            padding: 2.5rem 2rem; border-radius: 20px; box-shadow: 0 10px 30px rgba(15, 76, 129, 0.25);
        ...
        .credit-note { text-align: center; color: #a3b2c2; font-size: 0.95rem; margin-top: 0.5rem; }
        section[data-testid="stSidebar"] .credit-note { text-align: left; color: #b9c7d6 !important; line-height: 1.5; }
    </style>
...
with st.sidebar:
    ...
    st.markdown(
        '<div class="credit-note" style="margin-top:0.8rem;">AI Prototype Developed by: Nikita Chougule<br>'
        'Medical Content Support: Mayur Deokar (Senior Radiation Therapist)</div>',
        unsafe_allow_html=True,
    )
...
if VIDEO_PATH:
    st.write(VIDEO_PATH.exists())
    st.write(VIDEO_PATH.stat().st_size)
