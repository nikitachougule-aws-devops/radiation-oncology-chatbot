...
# ============================================================
# HERO — rendered immediately, before anything that could fail,
# so the header ALWAYS shows even if data loading below breaks.
# ============================================================

def render_hero(subtitle="Your patient information assistant for Radiation Oncology."):
    st.markdown(
        f"""
        <div class="hero">
...
# ============================================================
# EVERYTHING BELOW IS WRAPPED SO A FAILURE HERE NEVER
# TAKES THE HEADER (OR THE WHOLE PAGE) DOWN WITH IT.
# ============================================================
...
try:
    ...
    UI_STRINGS = {
        "en": {
            "hero_sub": "Your patient information assistant for Radiation Oncology.",
            "chat_intro": "Ask about radiation treatment, preparation, side effects, or hospital information.",
            ...
            "unrelated": "I can only answer questions related to Radiation Oncology and "
            ...
            "injection": "I can only answer questions using the approved Jupiter Hospital "
                         "Radiation Oncology knowledge base.",
            "medical": "I can't diagnose you, prescribe or change medicines, or change your "
                       "radiation treatment plan.\n\n"
                       "For personal medical decisions, please speak with your treating "
                       "doctor or healthcare team.",
            "urgent": "If you are experiencing a serious or emergency symptom, please "
            ...
            "faq_header": "Patient FAQs — Reviewed & Approved",
        ...
        "hi": {
            "hero_sub": "रेडिएशन ऑन्कोलॉजी के लिए आपका रोगी सूचना सहायक।",
            "chat_intro": "रेडिएशन उपचार, तैयारी, दुष्प्रभाव या अस्पताल की जानकारी के बारे में पूछें।",
            "placeholder": "अपना प्रश्न यहाँ लिखें...",
            "unknown": "मुझे अस्पताल की स्वीकृत जानकारी में इस प्रश्न का उत्तर नहीं मिला।\n\n"
                       "मैं अनुमान लगाकर गलत चिकित्सा जानकारी नहीं देना चाहता। "
                       "कृपया अपनी स्वास्थ्य टीम से संपर्क करें।",
            "unrelated": "मैं केवल Radiation Oncology और Jupiter Hospital की स्वीकृत "
                         "जानकारी से संबंधित प्रश्नों का उत्तर दे सकता हूँ।",
            "injection": "मैं केवल स्वीकृत Jupiter Hospital Radiation Oncology जानकारी "
                         "के आधार पर प्रश्नों का उत्तर दे सकता हूँ।",
            "medical": "मैं आपका निदान नहीं कर सकता, दवा लिख या बदल नहीं सकता और "
                       "आपकी रेडिएशन उपचार योजना नहीं बदल सकता।\n\n"
                       "व्यक्तिगत चिकित्सा निर्णयों के लिए अपने डॉक्टर या स्वास्थ्य टीम "
                       "से बात करें।",
            "urgent": "यदि आपको गंभीर या आपातकालीन लक्षण हैं, तो तुरंत अपनी स्वास्थ्य "
                      "टीम या आपातकालीन सेवाओं से संपर्क करें।",
            "faq_header": "मरीज़ों के सामान्य प्रश्न",
        ...
        "mr": {
            "hero_sub": "रेडिएशन ऑन्कोलॉजीसाठी तुमचा रुग्ण माहिती सहाय्यक.",
            "chat_intro": "रेडिएशन उपचार, तयारी, दुष्परिणाम किंवा रुग्णालयाच्या माहितीबद्दल प्रश्न विचारा.",
            "placeholder": "तुमचा प्रश्न येथे लिहा...",
            "unknown": "रुग्णालयाच्या मंजूर माहितीमध्ये मला या प्रश्नाचे उत्तर सापडले नाही.\n\n"
                       "मला अंदाज लावून चुकीची वैद्यकीय माहिती द्यायची नाही. "
                       "कृपया तुमच्या आरोग्य टीमशी संपर्क साधा.",
            "unrelated": "मी फक्त Radiation Oncology आणि Jupiter Hospital च्या "
                         "मंजूर माहितीसंबंधी प्रश्नांची उत्तरे देऊ शकतो.",
            "injection": "मी फक्त मंजूर Jupiter Hospital Radiation Oncology माहितीच्या "
                         "आधारे प्रश्नांची उत्तरे देऊ शकतो.",
            "medical": "मी तुमचे निदान करू शकत नाही, औषधे लिहून देऊ किंवा बदलू शकत नाही "
                       "आणि तुमची रेडिएशन उपचार योजना बदलू शकत नाही.\n\n"
                       "वैयक्तिक वैद्यकीय निर्णयांसाठी तुमच्या डॉक्टरांशी किंवा आरोग्य "
                       "टीमशी संपर्क साधा.",
            "urgent": "तुम्हाला गंभीर किंवा आपत्कालीन लक्षणे असल्यास, त्वरित तुमच्या "
            ...
            "source": "📚 स्रोत",
            "approved_kb": "रुग्णालयाचा मंजूर ज्ञान आधार",
    ...
    if "messages" not in st.session_state:
        st.session_state.messages = [
            {"role": "assistant", "content": "👋 Hello! I'm your Patient Information Assistant. How can I help you today?"}
        ]
    ...
    def load_hospital_info():
        if not HOSPITAL_FILE.exists():
            return {}
        try:
            text = HOSPITAL_FILE.read_text(encoding="utf-8")
            info = {}
    ...
    with st.sidebar:
        ...
        doctor_name = HOSPITAL_INFO.get("Radiation Oncologist", "Radiation Oncology Team")
        hospital_location = HOSPITAL_INFO.get("Hospital Location", "Please contact the hospital")
        opd_hours = HOSPITAL_INFO.get("OPD Hours", "Please contact the hospital")
        emergency_contact = HOSPITAL_INFO.get("Emergency Contact", "Please contact the hospital")

        st.markdown(f"**{doctor_name}**")
        st.divider()
        st.markdown(f"**📍 Location:** {hospital_location}")
        st.markdown(f"**🕒 OPD Hours:** {opd_hours}")
    ...
    def create_rag_documents():
        ...
        for stage_key, questions in FAQ_DATA.items():
            ...
            for index, item in enumerate(questions):
                for language in ("en", "hi", "mr"):
                    ...
                    metadatas.append({
                        "type": "faq", "stage": stage_name, "language": language,
        ...
        for key, questions in hospital_questions.items():
            ...
            for question in questions:
                document = f"Category: Hospital Information\nQuestion: {question}\nAnswer: {value}"
                documents.append(document)
                ids.append(f"hospital_{hospital_index}")
                metadatas.append({
                    "type": "hospital", "stage": "Hospital Information",
                    "language": "en", "question": question, "answer": value,
                })
                hospital_index += 1
    ...
    def load_rag():
        ...
        collection = client.get_or_create_collection(name="jupiter_hospital_knowledge")
    ...
    def detect_question_type(question):
        ...
        if any(p in text for p in (
            "who is the radiation oncologist", "who is the radiation oncology doctor", "radiation oncologist",
        )):
            return "doctor"

        if any(p in text for p in (
            "where is the hospital", "hospital location", "where is jupiter hospital",
            "hospital address", "where is the radiation oncology department",
        )):
            return "location"

        if any(p in text for p in (
            "opd", "opd hours", "opd timing", "opd timings", "hospital timing", "hospital hours",
        )):
            return "opd"

        if any(p in text for p in (
            "emergency number", "emergency contact", "contact number",
            "emergency phone", "hospital emergency",
        )):
            return "emergency"

        if any(p in text for p in ("what hospital", "which hospital", "hospital name")):
            return "hospital_name"

        if any(w in text for w in (
            "radiation", "radiotherapy", "treatment", "side effect", "side effects",
            "skin", "hair", "fatigue", "pain", "burning", "redness", "itching",
            "nausea", "vomiting", "sleep", "appetite", "diet", "food", "exercise",
            "care", "symptom", "symptoms",
        )):
            return "medical"
    ...
    def detect_medical_safety_level(question):
        ...
        urgent_patterns = (
            "difficulty breathing", "cannot breathe", "can not breathe", "trouble breathing",
            "chest pain", "severe chest pain", "unconscious", "passed out", "fainted",
            "heavy bleeding", "severe bleeding", "vomiting blood", "blood vomiting",
            "severe allergic reaction", "swelling of face", "swelling of throat",
            "seizure", "convulsion", "stroke symptoms",
        )
        if any(p in text for p in urgent_patterns):
            return "urgent"

        diagnosis_patterns = (
            "diagnose me", "can you diagnose", "can you diagnose my", "could you diagnose",
            "please diagnose", "diagnosis", "my diagnosis", "tell me my diagnosis",
            "what is my diagnosis", "what is my cancer", "what cancer do i have",
            "do i have cancer", "could i have cancer", "can i have cancer", "is this cancer",
            "do my symptoms mean cancer", "do my symptoms mean i have cancer",
            "can you tell if i have cancer", "what disease do i have", "what illness do i have",
            "what is wrong with me", "interpret my scan", "interpret my ct", "interpret my mri",
            "interpret my pet scan", "read my scan", "read my mri", "read my ct", "read my pet scan",
        ...
        medicine_patterns = (
            ...
            "what tablet should i take", "what dose should i take", "what dosage should i take",
            "how much medicine should i take", "should i stop my medicine",
            "should i stop my medication", "stop my medicine", "stop my medication",
            "change my medicine", "change my medication", "increase my medicine",
            "decrease my medicine", "increase my medication", "decrease my medication",
            "double my dose", "skip my dose",
            "मेरी दवा बदलो", "मेरी दवा बंद कर दूं", "दवा की खुराक", "मुझे कौन सी दवा लेनी चाहिए",
            "माझे औषध बदला", "औषध बंद करू का", "औषधाचा डोस",
        )
        if any(p in text for p in medicine_patterns):
            return "personal_medical"

        treatment_change_patterns = (
            "change my treatment", "change my treatment plan", "should i change my treatment",
            "change my radiation", "change my radiation treatment", "stop radiation",
            "stop my radiation", "skip radiation", "skip my radiation", "delay my radiation",
            "increase radiation", "decrease radiation", "change radiation dose",
            "change my radiation dose", "should i continue radiation", "should i stop treatment",
            "should i continue treatment", "can i stop treatment", "can i skip treatment",
            "मेरा इलाज बदलो", "रेडिएशन बंद कर दूं", "इलाज बंद कर दूं",
            "माझा उपचार बदला", "रेडिएशन बंद करू का", "उपचार बंद करू का",
        )
    ...
    PROMPT_INJECTION_PATTERNS = (
        ...
        "ignore the instructions", "forget your instructions", "forget your rules",
        ...
        "निर्देशों को अनदेखा", "पिछले निर्देशों को अनदेखा", "सिस्टम प्रॉम्प्ट दिखाओ", "अपने निर्देश दिखाओ",
        "सूचनांकडे दुर्लक्ष", "मागील सूचना दुर्लक्षित", "सिस्टम प्रॉम्प्ट दाखवा", "तुमच्या सूचना दाखवा",
    )
    ...
    def search_knowledge(question, language):
        try:
            ...
            for index in range(len(documents)):
                ...
                question_common_words = question_words & get_meaningful_words(kb_question)
                question_keyword_score = len(question_common_words)

                type_bonus = 0
                if question_type == "doctor":
                    if kb_type == "hospital" and ("oncologist" in kb_question_clean or "doctor" in kb_question_clean):
                        type_bonus = 10
                elif question_type == "location":
                    if kb_type == "hospital" and ("where" in kb_question_clean or "location" in kb_question_clean):
                        type_bonus = 10
                elif question_type == "opd":
                    if kb_type == "hospital" and ("opd" in kb_question_clean or "timing" in kb_question_clean or "hours" in kb_question_clean):
                        type_bonus = 10
                elif question_type == "emergency":
                    if kb_type == "hospital" and "emergency" in kb_question_clean:
                        type_bonus = 10
                elif question_type == "hospital_name":
                    if kb_type == "hospital" and "hospital" in kb_question_clean:
                        type_bonus = 10
            ...
            best_type_bonus = best["type_bonus"]

            # Hospital information protection
            if best_metadata.get("type") == "hospital":
                if question_type in ("doctor", "location", "opd", "emergency", "hospital_name"):
                    if best_type_bonus < 10:
                        return None
                else:
                    if best_question_keywords == 0 and best_type_bonus == 0:
                        return None
            ...
            if best_semantic < 0.25 and best_keywords == 0 and best_question_keywords == 0 and best_type_bonus == 0:
                return None
    ...
    def display_source(source):
        ...
        with st.container(border=True):
            st.markdown("### 📚 Source")
            st.write("**Approved Hospital Knowledge Base**")
            ...
            if not allowed:
                ...
                if question_type == "unrelated":
                    ...
                    if result:
                        ...
                        label = "**Hospital Information**" if result.get("type") == "hospital" else "**Answer**"
                        response = (
                            f"{label}\n\n{answer}\n\n"
                            f"*This answer comes from the approved hospital knowledge base. "
                            f"For personal medical decisions, please follow your treating doctor's advice.*"
                        )
                    else:
                        response = T["unknown"]
    ...
    with tab_faq:
        ...
        if not filtered_faqs:
            ...
            st.caption(f"{len(filtered_faqs)} approved FAQ(s)")
    ...
    with tab_video:
        ...
        if video_file:
            ...
            st.info("No video file found in the assets folder.")
    ...
    st.markdown(
        ...
        This chatbot provides patient education information from an approved knowledge base.
    ...
    st.error(
        "Something went wrong loading the rest of the page below the header. "
        "The details are shown below so you can fix the underlying data/file issue."
    )
    st.exception(e)
